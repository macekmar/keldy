...
TEST(ComputeObs, InitializeInverseSquare) { // NOLINT
  ...
  computer.warper.emplace_back(warpers::make_product_1d_simple_inverse_square(time, 1.5));
...
TEST(ComputeObs, InitializeExponential) { // NOLINT
  ...
  computer.warper.emplace_back(warpers::warper_plasma_uv_t{time});
  computer.warper.emplace_back(warpers::make_product_1d_simple_exponential(time, 1.5));
...
TEST(ComputeChargeQDirect, FlatbandAnalyticCompare1) { // NOLINT
  ...
  for (int order = 1; order <= 6; ++order) {
    ...
    computer.warper.emplace_back(warpers::make_product_1d_simple_inverse_square(t_max, 1.0));
...
TEST(ComputeChargeQDirect, FlatbandAnalyticCompare2) { // NOLINT
  ...
  for (int order = 1; order <= 6; ++order) {
    ...
    computer.warper.emplace_back(warpers::warper_plasma_uv_t{t_max});
    computer.warper.emplace_back(warpers::make_product_1d_simple_exponential(t_max, 2.0));
...
TEST(ComputeObs, ValueCurrent1) { // NOLINT
  ...
  computer.warper.emplace_back(warpers::warper_plasma_uv_t{t_max});
  computer.warper.emplace_back(warpers::make_product_1d_simple_inverse_square(t_max, 0.5));
