...
TEST(SimpleProduct1DWarper, InterpNearest_IdentityConstructorVector) { // NOLINT
  double const t_max = 1.5;
  nda::vector<double> times = {0., 0.5, 0.75, 1., t_max};
  nda::vector<double> f1 = {1., 1., 1., 1., 1.};
  auto const warper = warper_product_1d_simple_interp_nearest_t(times, f1);
