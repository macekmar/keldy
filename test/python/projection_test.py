...
class projection_maker_usage(unittest.TestCase):
    ...
    def test_example(self):
        ...
        nr_bins = 500
        nr_samples = 5000
        warper_proj = warpers.make_warper_from_proj(lambda l: np.abs(computer.evaluate_warped_integrand(l, warper_train.size(), False)[0]),
                                                order, nr_bins, nr_samples, 0.1)
