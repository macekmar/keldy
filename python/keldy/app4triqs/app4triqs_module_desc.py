...
# c++2py ../../c++/keldy/keldy.hpp -p --members_read_only -N keldy -a keldy -m keldy_module -o keldy_module --moduledoc="The keldy python module" -C pytriqs --cxxflags="-std=c++17" --target_file_only
from cpp2py.wrap_generator import *

# The module
module = module_(full_name = "keldy_module", doc = r"", app_name = "keldy")

# Imports

# Add here all includes
module.add_include("keldy/keldy.hpp")
