...
#include "gsl_integration_wrap.hpp"
...
void gsl_integration_wrapper_t::integrate_qag(std::function<double(double)> const &f, double a, double b, double epsabs,
...
void gsl_integration_wrapper_t::integrate_qagi(std::function<double(double)> const &f, double epsabs, double epsrel) {
  gsl_function f_gsl;
  f_gsl.function = [](double x, void *param) { return (*static_cast<std::function<double(double)> *>(param))(x); };
  f_gsl.params = (void *)&f;
...
void gsl_integration_wrapper_t::integrate_qagiu(std::function<double(double)> const &f, double a, double epsabs,
                                                double epsrel) {
  gsl_function f_gsl;
  f_gsl.function = [](double x, void *param) { return (*static_cast<std::function<double(double)> *>(param))(x); };
  f_gsl.params = (void *)&f;
...
void gsl_integration_cpx_wrapper_t::integrate_qag(std::function<dcomplex(double)> const &f, double a, double b,
...
void gsl_integration_cpx_wrapper_t::integrate_qagi(std::function<dcomplex(double)> const &f, double epsabs,
                                                   double epsrel) {
  // real part
  auto f_real = [&f](double t) { return std::real(f(t)); };
...
void gsl_integration_cpx_wrapper_t::integrate_qagiu(std::function<dcomplex(double)> const &f, double a, double epsabs,
                                                    double epsrel) {
  // real part
  auto f_real = [&f](double t) { return std::real(f(t)); };
